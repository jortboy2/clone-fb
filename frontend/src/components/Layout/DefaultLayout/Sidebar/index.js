...
function SideBar(props) {
  return (
    <div className="w-80 h-screen bg-transparent text-[#fff] p-3 sidebar sticky left-0 top-14">
      <div className="w-full border-solid border-b border-[#f3f4f5]/30">
        <div className="list-none py-2">
          <li className="py-2 px-2 flex items-center gap-3 hover:bg-[#fff]/10 hover:rounded-lg">
            ...
            <span className="font-semibold text-[15px]">Thanh Phong</span>
          </li>
          <li className="py-2 px-2 flex items-center gap-3 hover:bg-[#fff]/10 hover:rounded-lg">
            <i
              style={{
          ...
          <li className="py-2 px-2 flex items-center gap-3 hover:bg-[#fff]/10 hover:rounded-lg">
            ...
            ></i>
            <span className="font-semibold text-[15px]">Video</span>
          </li>
          <li className="py-2 px-2 flex items-center gap-3 hover:bg-[#fff]/10 hover:rounded-lg">
            <i
              style={{
            ...
            ></i>
            <span className="font-semibold text-[15px]">Nhóm</span>
          </li>
          <li className="py-2 px-2 flex items-center gap-3 hover:bg-[#fff]/10 hover:rounded-lg">
            <i
              style={{
            ...
            ></i>
            <span className="font-semibold text-[15px]">Kỷ niệm</span>
          </li>
          <li className="py-2 px-2 flex items-center gap-3 hover:bg-[#fff]/10 hover:rounded-lg">
            <i
              style={{
            ...
            ></i>
            <span className="font-semibold text-[15px]">Đã lưu</span>
          </li>
          <li className="py-2 px-2 flex items-center gap-3 hover:bg-[#fff]/10 hover:rounded-lg">
            <div className="w-9 h-9 bg-[#3A3B3C] rounded-full flex justify-center items-center text-[#fff]/60">
              <FaChevronDown />
            </div>
            <span className="font-semibold text-[15px]">Xem thêm</span>
          </li>
        </div>
      </div>
      {/* start  Shortcut*/}
      <div className="w-full my-2  bg-transparent ">
        ...
        <div className="my-2 px-2 py-2 list-none ">
          <li className="py-2 flex items-center gap-3">
            ...
            <span className="font-semibold text-[15px]">Cờ Caro</span>
          </li>
          <li className="py-2 flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg">
              <img
            ...
            <span className="font-semibold text-[15px]">Vân vũ</span>
          </li>
          <li className="py-2 flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg">
              <img
